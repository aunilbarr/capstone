package com.example.fayyadhaunilbarr.core.data
...
import com.example.fayyadhaunilbarr.core.utils.DataMapper
import kotlinx.coroutines.flow.map

class MovieRepository(
    private val remoteDataSource: com.example.fayyadhaunilbarr.core.data.source.remote.RemoteDataSource,
    private val localDataSource: com.example.fayyadhaunilbarr.core.data.source.local.LocalDataSource
) :
    IMovieRepository {
    ...
    override fun checkFavoriteMovie(id: Int): LiveData<Boolean> {
        ...
        localDataSource.check(id, object : com.example.fayyadhaunilbarr.core.data.source.local.LocalDataSource.CheckFavoriteCallback{
            override fun onChecked(entity: com.example.fayyadhaunilbarr.core.data.source.local.entity.id?) {
